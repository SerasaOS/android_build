...
ifneq ($(MORBID_BUILD),)
include vendor/morbid/config/BoardConfigMorbid.mk
endif
...
ifneq ($(MORBID_BUILD),)
ifneq ($(wildcard device/morbid/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/morbid/sepolicy/common/sepolicy.mk)
endif
endif
